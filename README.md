...
describe() is used for organizing the tests ( describe a component) while it() is used to do the actual tests on the component

1. What is the point of `Test Driven Development`? What do you think about this approach?
This allows the developer to make sure the code they write is correct. Basically reverse engineer the code before actually writing it. This is a good approach because it makes it alot harder to make mistakes without catching them

1. Mention three types of automated tests.
end to end, unit testing, integration
